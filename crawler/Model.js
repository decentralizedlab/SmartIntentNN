...
module.exports = {
    ...
    Code: {
        ...
        table: {
            ...
            ContractAddress: { type: DataTypes.STRING, unique: true },
            SourceCode: DataTypes.TEXT('medium'),
            SourceCodeMap: DataTypes.TEXT('medium'),
            OpCode: DataTypes.TEXT('medium'),
            OpCodeDeployed: DataTypes.TEXT('medium'),
            ByteCode: DataTypes.TEXT('medium'),
            ByteCodeDeployed: DataTypes.TEXT('medium'),
            MethodIdentifiers: DataTypes.TEXT('medium'),
            ABI: DataTypes.TEXT('medium'),
            Assembly: DataTypes.TEXT('medium'),
            Embedding: DataTypes.TEXT('long'),
            DevDoc: DataTypes.TEXT('medium')
        },
        options: {
            charset: 'utf8mb4',
            collate: 'utf8mb4_general_ci'
